...
var custom_scrollbar_size_value = 6; // in px // default: custom_scrollbar_size_value = 17
var custom_scrollbar_opacity = false; // default: custom_scrollbar_opacity = false
var custom_opacity_value = "0.3"; // default: custom_opacity_value = "1.0"
// floating scrollbars
...
var cs_thumb_roundness = 1; // in px // default: cs_thumb_roundness = 0
...
var cs_background_image_vertical = "linear-gradient(to right,transparent,rgba(128,128,128,0.5),transparent)"; // default: cs_background_image_vertical = "unset"
var cs_background_image_horizontal = "linear-gradient(to bottom,transparent,rgba(128,128,128,0.5),transparent)"; // default: cs_background_image_horizontal = "unset"
// - corner
...
// - thumb/slider
var cs_thumb_color = "#888"; // default: cs_thumb_color = "#33CCFF"
var cs_thumb_image_vertical = "linear-gradient(to right,transparent,rgba(0,0,0,0.4),transparent)"; // default: cs_thumb_image_vertical = "unset"
var cs_thumb_image_horizontal = "linear-gradient(to bottom,transparent,rgba(0,0,0,0.4),transparent)"; // default: cs_thumb_image_horizontal = "unset"
var cs_thumb_hover_color = "#444"; // default: cs_thumb_hover_color = "#66FFFF"
var cs_thumb_hover_image_vertical = "linear-gradient(to right,transparent,rgba(0,0,0,0.8),transparent)"; // default: cs_thumb_hover_image_vertical = "unset"
var cs_thumb_hover_image_horizontal = "linear-gradient(to bottom,transparent,rgba(0,0,0,0.8),transparent)"; // default: cs_thumb_hover_image_horizontal = "unset"
var cs_thumb_border_color = "#444"; // default: cs_thumb_border_color = "#33CCFF"
// - buttons
var cs_buttons_color = "#888"; // default: cs_buttons_color = "#66FFFF"
var cs_buttons_image_vertical = "linear-gradient(to right,transparent,rgba(0,0,0,0.4),transparent)"; // default: cs_buttons_image_vertical = "unset"
var cs_buttons_image_horizontal = "linear-gradient(to bottom,transparent,rgba(0,0,0,0.4),transparent)"; // default: cs_buttons_image_horizontal = "unset"
var cs_buttons_hover_color = "#444"; // default: cs_buttons_hover_color = "#33CCFF"
var cs_buttons_hover_image_vertical = "linear-gradient(to right,transparent,rgba(0,0,0,0.8),transparent)"; // default: cs_buttons_hover_image_vertical = "unset"
var cs_buttons_hover_image_horizontal = "linear-gradient(to bottom,transparent,rgba(0,0,0,0.8),transparent)"; // default: cs_buttons_hover_image_horizontal = "unset"
// - button arrows
var cs_arrows_on_buttons_color = "#444"; // default: cs_arrows_on_buttons_color = "#33CCFF"
var cs_arrows_on_buttons_hover_color = "#888"; // default: cs_arrows_on_buttons_hover_color = "#66FFFF"
